...
@CommandType(action = "GET", entity = "SHOW_SEAT_TYPE")
public class GetShowSeatTypeCommandHandler implements CommandHandler {

    private final ShowSeatTypeService showSeatTypeService;

    @Override
    public OutputCommand execute(InputCommand request) {
        return showSeatTypeService.getShowSeatType(request);
    }
}
