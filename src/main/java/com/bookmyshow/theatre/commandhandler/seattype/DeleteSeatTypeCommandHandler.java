...
@CommandType(action = "DELETE", entity = "SEATTYPE")
public class DeleteSeatTypeCommandHandler implements CommandHandler {

    private final SeatTypeService seatTypeService;

    @Override
    public OutputCommand execute(InputCommand request) {
        return seatTypeService.deleteSeatType(request);
    }
}