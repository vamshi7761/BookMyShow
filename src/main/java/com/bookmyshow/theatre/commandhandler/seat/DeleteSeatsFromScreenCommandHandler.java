...
@CommandType(action = "DELETE", entity = "SEAT")
public class DeleteSeatsFromScreenCommandHandler implements CommandHandler {

    private final SeatService seatService;

    @Override
    public OutputCommand execute(InputCommand request) {
        return seatService.deleteSeatsFromScreen(request);
    }
}