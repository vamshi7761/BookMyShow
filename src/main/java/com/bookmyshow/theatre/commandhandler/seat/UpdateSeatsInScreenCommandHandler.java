...
@CommandType(action = "UPDATE", entity = "SEAT")
public class UpdateSeatsInScreenCommandHandler implements CommandHandler {

    private final SeatService seatService;

    @Override
    public OutputCommand execute(InputCommand request) {
        return seatService.updateSeatsInScreen(request);
    }
}