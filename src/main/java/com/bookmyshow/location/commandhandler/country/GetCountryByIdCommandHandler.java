...
@CommandType(action = "GET_BY_ID", entity = "COUNTRY")
public class GetCountryByIdCommandHandler implements CommandHandler {

    private final CountryService countryService;

    @Override
    public OutputCommand execute(InputCommand request) {
        return countryService.getCountryById(request);
    }
}